...
module.exports = (function() {
  ...
  var adapter = {
    identity: 'sails-postgresql-cluster',
    ...
    describe: function(connectionName, table, cb) {
      spawnConnection(connectionName, function __DESCRIBE__(client, cb) {
        ...
        var newCluster = connectionObject.config.newCluster; // look for parameter
        var compatible = function (s) { return newCluster ? "" : s; }; // ignore the field if v12+
